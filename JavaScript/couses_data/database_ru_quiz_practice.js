...
const lesson1_quiz_practice = {
  ...
  practiceTask: `
    ...
    <ol>
      <li>Назовите основные типы баз данных и опишите их различия</li>
      <li>Перечислите основные компоненты реляционной базы данных</li>
      <li>Создайте пример таблицы для базы данных (например, таблица "Ученики"), укажите ее столбцы и типы данных</li>
      <li>Что такое первичный ключ (Primary Key) и для чего он используется?</li>
      <li>Создайте схему базы данных, содержащую минимум 3 таблицы, укажите связи между ними</li>
    </ol>
  `,
...
const lesson3_quiz_practice = {
  ...
  practiceTask: `
    ...
    <ol>
      <li>Напишите запрос для выборки всех учеников из таблицы</li>
      <li>Напишите запрос с использованием оператора WHERE для выборки учеников из 10-го класса</li>
      <li>Напишите запрос для выборки учеников старше 15 лет</li>
      <li>Напишите запрос для выборки учеников, чьи имена начинаются на букву "А" и возраст больше 16 лет</li>
      <li>Напишите запрос для выборки учеников, которые учатся в 10-м классе или старше 15 лет</li>
    </ol>
  `,
